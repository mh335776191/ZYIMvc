// =================================================================== 
// 【宋】常用工具集·分页（DawnXZ.Pagination）项目
//====================================================================
//【宋杰军 @Copy Right 2008+】--【联系ＱＱ：6808240】--【请保留此注释】
//====================================================================
// 文件名称：DawnPagerEng.cs
// 项目名称：【宋】常用工具集
// 创建时间：2010-11-09
// 创建人员：宋杰军
// 负 责 人：宋杰军
...
namespace ZY.Extensions
{
    ...
    public class DawnPagerEng
    {
        ...
        public DawnPagerEng(int digitalpagesize)
        {
            this.PageCurrent = 1;
            this.PageCount = 0;
            this.PageSize = 40;
        ...
        /// <param name="digitalpagesize">数字分页—每页个数</param>
        public DawnPagerEng(int pagesize, int digitalpagesize)
        {
            this.PageCurrent = 1;
            this.PageCount = 0;
        ...
        /// <param name="pagesize">每页显示记录数</param>
        /// <param name="digitalpagesize">数字分页—每页个数</param>
        public DawnPagerEng(int pagecurrent, int pagecount, int pagesize, int digitalpagesize)
        {
            if (pagecurrent > -1)
            {
        ...
        public string ShowPagerByForward(string urlPath, string pagerName, string parameter, bool outPageCount, bool showSelect)
        {
            ...
            if (outPageCount)
            {
                ...
                {
                    sb.AppendFormat("Total: {0}, Per: {1}/{2}, Page: {3}/{4}&nbsp;&nbsp;", this.RecordCount, this.PageRecordCount, this.PageSize, this.PageCurrent, this.PageCount);
                }
                else
                {
                    sb.AppendFormat("Total: {0}, Per: {1}, Page: {2}/{3}&nbsp;&nbsp;", this.RecordCount, this.PageSize, this.PageCurrent, this.PageCount);
                }
            }
            else
            {
            ...
            {
                sb.AppendFormat("<a href=\"{0}?{1}=1{2}\">First</a>", urlPath, pagerName, parameter);
            }
            //上一页
            if (this.PageCurrent <= 1)
            {
                sb.Append("&nbsp;&nbsp;<span>Prev</span>&nbsp;&nbsp;");
            }
            else
            {
                sb.AppendFormat("&nbsp;&nbsp;<a href=\"{0}?{1}={2}{3}\">Prev</a>&nbsp;&nbsp;", urlPath, pagerName, this.PageCurrent - 1, parameter);
            }
            //下一页
            ...
            {
                sb.AppendFormat("<a href=\"{0}?{1}={2}{3}\">Next</a>&nbsp;&nbsp;", urlPath, pagerName, this.PageCurrent + 1, parameter);
            }
            //末页
            if (this.PageCurrent == this.PageCount | this.PageCount == 0)
            {
                sb.Append("<span>Last</span>");
            }
            else
            {
                sb.AppendFormat("<a href=\"{0}?{1}={2}{3}\">Last</a>", urlPath, pagerName, this.PageCount, parameter);
            }
            //页码选择器
            if (showSelect)
            {
        ...
        public string ShowPagerOfScriptByForward(string urlPath, string parameter, bool outPageCount, bool showSelect, PagerType pagerType)
        {
            ...
            {
                sb.AppendFormat("<a href=\"javascript:void(0);\" onclick=\"{0}('{1}',1,'{2}');\">First</a>", jsFunName, urlPath, parameter);
            }
            //上一页
            if (this.PageCurrent <= 1)
            {
            ...
            {
                sb.AppendFormat("&nbsp;&nbsp;<a href=\"javascript:void(0);\" onclick=\"{0}('{1}',{2},'{3}');\">Prev</a>&nbsp;&nbsp;", jsFunName, urlPath, this.PageCurrent - 1, parameter);
            }
            //下一页
            if (this.PageCurrent >= this.PageCount)
            {
            ...
            {
                sb.AppendFormat("<a href=\"javascript:void(0);\" onclick=\"{0}('{1}',{2},'{3}');\">Next</a>&nbsp;&nbsp;", jsFunName, urlPath, this.PageCurrent + 1, parameter);
            }
            //末页
            if (this.PageCurrent == this.PageCount | this.PageCount == 0)
            {
            ...
            {
                sb.AppendFormat("<a href=\"javascript:void(0);\" onclick=\"{0}('{1}',{2},'{3}');\">Last</a>", jsFunName, urlPath, this.PageCount, parameter);
            }
            //页码选择器
            if (showSelect)
            {
